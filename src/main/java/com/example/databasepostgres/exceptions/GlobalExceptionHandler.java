...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler({
			PongException.class,
			PongException.AuthorizationFailed.class,
			PongException.BadRequest.class,
			PongException.Edit.class,
			PongException.FaultIsComplete.class,
			PongException.Forbidden.class,
			PongException.InputParamNotValid.class,
			PongException.ItemNotFound.class,
			PongException.NotFound.class,
			PongException.Post.class,
			PongException.ServerError.class,
			PongException.ValidationFailure.class,
